...
**Rust** 
- Async programming with Tokio (spawning tasks, join patterns, runtime management)
- PyO3 for Python bindings
- Error handling with Result/Option
- Ownership, lifetimes, and the borrow checker
...
## Origin Story
Started programming 5 years ago to build a Discord bot in Python. Now i have gained knowledge from low-level memory management to high-level architecture patterns.
